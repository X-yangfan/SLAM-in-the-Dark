...
"""
============================================================================
DarkSLAM Inverse Warp

This module contains the inverse warping utilities for view synthesis.
...
def inverse_warp(*args, **kwargs):
    """Inverse warp - Code not yet released"""
    raise NotImplementedError("Inverse warp code not yet released.")


def inverse_warp2(*args, **kwargs):
    """Inverse warp v2 - Code not yet released"""
    raise NotImplementedError("Inverse warp code not yet released.")
